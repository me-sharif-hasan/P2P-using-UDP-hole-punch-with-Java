...
public class Settings {
    ...
    public static String []DEFAULT_STUN_SERVER={"stunserver.stunprotocol.org","stun3.l.google.com"};//"127.0.0.1";//"stun.l.google.com";
    public static int DEFAULT_STUN_PORT=3478;
}
